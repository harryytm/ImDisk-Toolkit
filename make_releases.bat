...
"%ProgramW6432%\7-Zip\7z.exe" a ImDiskTk.7z .\files\* -xr!ia64 -mm=LZMA -mx=9 -mmc=1000000000
...
"%ProgramW6432%\7-Zip\7z.exe" a ImDiskTk.7z .\files\* -xr!ia64 -x!driver\awealloc\i386 -x!driver\svc\i386 -x!driver\sys\i386 -mm=LZMA -mx=9 -mmc=1000000000
