...
\mingw64\bin\gcc.exe -mno-sse3 RamDyn.c "%TEMP%\resource.o" -o RamDyn64.exe^
 -municode -s -O3 -minline-all-stringops -Wall -lmsvcrt -lkernel32 -lntdll -luser32 -lshlwapi -lwtsapi32
...
\mingw32\bin\gcc.exe RamDyn.c "%TEMP%\resource.o" -o RamDyn32.exe^
 -municode -s -O3 -minline-all-stringops -Wall -lmingwex -lgcc -lmsvcrt -lkernel32 -lntdll -luser32 -lshlwapi -lwtsapi32
